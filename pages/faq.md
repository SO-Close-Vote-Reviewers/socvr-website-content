...
11. <a id="GEfM-cv-pls-not-a-habit" href="#GEfM-cv-pls-not-a-habit" class="hover-visible"></a><a id="not-habit"></a>Moderation requests (e.g. [`cv-pls`](https://meta.stackoverflow.com/a/262359), `del-pls`, etc.) should **not** be a habit for users. 
   ...
   cv-pls is for questions that:
    ...
    del-pls is for posts that:
      ...
      - Are within 1 downvote of being elegible for delete-votes (see [Shog9's answer to "Downvote in order to be able to vote to delete. Is it acceptable?"](https://meta.stackoverflow.com/questions/351969/downvote-in-order-to-be-able-to-vote-to-delete-is-it-acceptable/351971#351971))  
  That means you are permitted to post `del-pls` requests for closed questions which have a score <= -2, and/or which have been closed for more than 2 days; or answers which have a score <= 0.  
